        ...
        <div className="max-w-7xl mx-auto w-full grid md:grid-cols-[1fr_1.1fr] gap-12 items-center">
          ...
          <div>
            ...
            <h1 className="font-display font-600 leading-[0.88] text-foreground mb-6" style={{ fontSize: "clamp(3.5rem, 8vw, 7rem)" }}>
              Find the outfit.<br />
              Feel the <em className="text-cobalt not-italic" style={{ fontStyle: "italic" }}>shift.</em>
            </h1>
            ...
            <div className="flex gap-3 mb-8">
              <Link href="/get-outfit-ideas">
                <Button
                  className="rounded-full px-7 py-5 bg-navy hover:bg-navy/90 text-white text-xs tracking-widest uppercase font-500"
            ...
            {/* Email capture */}
            {joined ? (
              <p className="text-sm text-cobalt font-500">You're on the list ✓</p>
            ) : (
              <form onSubmit={handleJoin} className="flex gap-2 max-w-sm">
                <input
                  ...
                  className="flex-1 bg-white/70 border border-white/60 rounded-full px-5 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-cobalt/40 placeholder:text-foreground/40"
                />
                <button
                  type="submit"
                  className="bg-cobalt hover:bg-cobalt/90 text-white text-xs tracking-widest uppercase font-500 rounded-full px-5 py-3 transition-colors"
                >
                  Join
                </button>
              </form>
            ...
            {[
              ...
              <div
                ...
                className={`rounded-3xl p-8 flex flex-col justify-between min-h-[280px] ${
                  card.dark ? "bg-navy text-white" : "bg-white"
                }`}
              >
                <div>
          ...
          <div className="bg-white rounded-3xl overflow-hidden grid md:grid-cols-[1fr_1fr] shadow-sm">
            <div className="p-10 flex flex-col justify-center">
              ...
              <Link href="/style-quiz">
                <Button className="rounded-full bg-navy text-white text-xs tracking-widest uppercase px-7 py-5 w-fit">
                  Take the Quiz
                </Button>
              </Link>
            </div>
            <div className="bg-navy p-10 flex flex-col justify-center">
      ...
      <section className="px-6 md:px-10 py-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-[1fr_1fr] gap-10 items-center">
          <div>
            ...
            <Link href="/upload">
              <Button className="rounded-full bg-navy text-white text-xs tracking-widest uppercase px-7 py-5">
                Try It On
              </Button>
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-[1fr_1fr] gap-10 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <div className="flex gap-4">
              ...
              <div className="bg-navy rounded-2xl p-5 flex-1">
            ...
            <Link href="/closet">
              <Button className="mt-6 rounded-full bg-navy text-white text-xs tracking-widest uppercase px-7 py-5">
                Open My Closet
              </Button>
            </Link>
          </div>
